...
class CharacterDetailWireFrame {
    ...
    private var viewController: CharacterDetailViewController {
        let viewController: CharacterDetailViewController = CharacterDetailViewController(
            nibName: "CharacterDetailView",
            bundle: nil
        )
        let viewModel: CharacterDetailViewModel = CharacterDetailViewModel(
            characterListDecorator: self.characterListDecorator
        )
